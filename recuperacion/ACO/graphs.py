from ACO import ACO_for_Graphs
...
sol, fitnes_evolution, temp_phero_evolution = ACO_for_Graphs(n_ants=20,iterations=50,alpha=0.6,beta=0.3,max_pieces=30,pieces=pieces,x_dim=40,y_dim=40,heuristic=heuristic2)
